...
const Hero = () => {
    return (
        <div className="grid md:grid-cols-2">
            <div className="space-y-4 bg-[#d3e4fe] px-7 md:px-15 md:py-20 py-10 md:rounded-l-3xl max-sm:rounded-t-3xl ">
            ...
            <Image src={HeroImg} alt="Banner Img" height={400} width={400} className="w-full h-full md:rounded-r-3xl max-sm:rounded-b-3xl"></Image>
        </div>
    );
};
